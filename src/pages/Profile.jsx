...
import { getSessions, getPRs } from '../lib/db'
...
export default function Profile() {
  ...
  const [tab, setTab] = useState('overview') // overview | prs | settings
            ...
            {editing ? (
              <div style={{ display:'flex', flexDirection:'column', gap:14 }}>
                ...
                <div style={{ display:'flex', gap:10, marginTop:4 }}>
                  ...
                  <button onClick={saveProfile} disabled={saving} style={{ flex:2, background:'var(--accent)', border:'none', borderRadius:'var(--radius-sm)', padding:12, color:'#fff', fontWeight:700, fontSize:14 }}>{saving?'SAVING...':'SAVE'}</button>
                </div>
              </div>
            ) : (
